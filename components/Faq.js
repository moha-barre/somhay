...
return ( <section className="max-w-3xl mx-auto px-4 py-12"> <div className="text-center mb-10"> <HelpCircle className="w-12 h-12 mx-auto text-blue-600 mb-4" /> <h2 className="text-3xl font-bold text-gray-900 mb-2"> Frequently Asked Questions </h2> <p className="text-gray-600"> We’re here to make your shopping experience simple, safe, and smooth. Here are some common questions answered for you. </p> </div>
